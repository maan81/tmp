 ...
 echo $paginate;
  ...
  echo "<tr>";
	...
	echo "<td bgcolor=\"$row_color\" class=\"visitorsTableRow\" nowrap>
			...
			<input class=\"star star-5\" id=\"star-5".$starID."\" type=\"radio\" name=\"rating\" ".$var5." disabled />
			<label class=\"star star-5\" for=\"star-5".$starID."\"></label>
			<input class=\"star star-4\" id=\"star-4".$starID."\" type=\"radio\" name=\"rating\" ".$var4." disabled />
			<label class=\"star star-4\" for=\"star-4".$starID."\"></label>
			<input class=\"star star-3\" id=\"star-3".$starID."\" type=\"radio\" name=\"rating\" ".$var3." disabled />
			<label class=\"star star-3\" for=\"star-3".$starID."\"></label>
			<input class=\"star star-2\" id=\"star-2".$starID."\" type=\"radio\" name=\"rating\" ".$var2." disabled />
			<label class=\"star star-2\" for=\"star-2".$starID."\"></label>
			<input class=\"star star-1\" id=\"star-1".$starID."\" type=\"radio\" name=\"rating\" ".$var1." disabled />
			<label class=\"star star-1\" for=\"star-1".$starID."\"></label>
